...
public class KuisKelas4Activity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                if(answered == false) {
                    if(radio1.isChecked() || radio2.isChecked() || radio3.isChecked() || radio4.isChecked()) {
                        ...
                        Toast.makeText(KuisKelas4Activity.this, "Please select an option", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Log.e("tes","shownex");
                    showNextQuestion();
    ...
    private void addQuestions() {
        ...
        questionsList.add(new QuestionModel(
                "8² dibaca adalah", 0,
                "A. Delapan Pangkat Dua", 0,
                "B. Dua Kuadrat", 0,
                "C. Delapan Pangkat Tiga", 0,
                "D. Dua Pangkat Delapan", 0,
                2));
        questionsList.add(new QuestionModel(
                "Tentukan KPK dan FPB dari 100 dan 10", 0,
                "A. 10 x 2 dan 5 x 2", 0,
                "B. 2 x 2 x 2 x 5 dan 2 x 2", 0,
                "C. 2 x 5 dan 2 x 2", 0,
                "D. 2 x 2 x 5 x 5 dan 2 x 5", 0,
                3));
        questionsList.add(new QuestionModel(
                "Hasil dari  8 ² + 4 ² - 5 ²  adalah", 0,
                "A. 14", 0,
                "B. 55", 0,
                "C. 80", 0,
                "D. 105", 0,
                4));
        questionsList.add(new QuestionModel(
                "Tentukan hasil dari 14² : 7² adalah", 0,
                "A. 4", 0,
                "B. 2", 0,
                "C. 49", 0,
                "D. 7", 0,
                5));
        questionsList.add(new QuestionModel(
                "Doni mempunyai kertas persegi dengan luas adalah 64 cm². Berapakah sisi kertas tersebut?", 0,
                "A. 8 cm", 0,
                "B. 4 cm", 0,
                "C. 16 cm", 0,
                "D. 32 cm", 0,
                6));
        questionsList.add(new QuestionModel(
                "Sebidang tanah berbentuk persegi dengan panjang sisi 15 m. Berapa m² luas tanah tersebut?", R.drawable.gambartia,
                "A. 100 m²", 0,
                "B. 15 m²", 0,
                "C. 225 m²", 0,
                "D. 30 m²", 0,
        ...
        questionsList.add(new QuestionModel(
                "6² x 2² – 4²\n" +
                        "Hasil dari operasi hitung di atas adalah", 0,
                "A. 12", 0,
                "B. 52", 0,
                "C. 24", 0,
                "D. 128", 0,
                8));
        questionsList.add(new QuestionModel(
                "Berapakah akar pangkat tiga dari bilangan 50.653", 0,
                "A. 27", 0,
                "B. 37", 0,
                "C. 46", 0,
                "D. 26", 0,
                9));
        questionsList.add(new QuestionModel(
                "Akar dari 144 adalah", R.drawable.gambartiara,
                "A. 12", 0,
                "B. 14", 0,
                "C. 13", 0,
                "D. 10", 0,
